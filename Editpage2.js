...
const Editpage2=()=>{
  ...
  const printValues = e => {
    e.preventDefault();
    console.log(form.prem, form.ins_comp);
  };
    ...
    return(
      ...
      <div className="container">
            ...
            <Form.Group   controlId="formGridEmail">
                      ...
                      <Form.Group  controlId="formGridPassword">
                      <Form.Control type="text" readOnly = {true}  placeholder="" value={item.maj_ins} />
                      </Form.Group>
            ...
            <Row className="mainrow">
              ...
              <Form.Group id="frameworks" as={Col} >
                      ...
                      <Form.Group id="frameworks" as={Col} >
                     <Form.Select name="acc_type" value={item.acc_type} onChange={(e)=>{Setacctype(e.target.value)}}>
                     <option></option>
                     <option>أفراد</option>
                     <option>شركات</option>
                     </Form.Select>
                      ...
                      <Form.Control  name="cust_name" value={item.cust_name}  onChange={(e)=>{Setcustname(e.target.value)}} type="text"  placeholder="اسم الزبون"  />
                      </Form.Group>
                      <Form.Group id="frameworks" as={Col} >
                  ...
                  <Form.Group as={Col} controlId="formGridEmail">
                    ...
                    <Form.Control   type="number" placeholder="القسط" 
                    value={form.prem}
                    name="prem"
                    onChange={updateField}
                      />
                    ...
                    <Form.Control   type="number" placeholder="الرسوم" 
                    value={form.feez}
                    name="feez"
                    onChange={updateField}
                     />
